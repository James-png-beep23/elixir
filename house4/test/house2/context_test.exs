defmodule House2.ContextTest do
  use House2.DataCase

  alias House2.Context

  describe "apartments" do
    alias House2.Context.Apartment

    import House2.ContextFixtures

    @invalid_attrs %{name: nil, number_floors: nil}
  ...
  describe "floor" do
    alias House2.Context.Floor

    import House2.ContextFixtures

    @invalid_attrs %{name: nil}

    test "list_floor/0 returns all floor" do
      floor = floor_fixture()
      assert Context.list_floor() == [floor]
    end
