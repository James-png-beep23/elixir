defmodule House2.Context do
 ...
 def list_apartments_with_floors do
  Repo.all(Apartment) |> Repo.preload(:floors)
end

def get_apartment_with_floors!(id) do
  Repo.get!(Apartment, id) |> Repo.preload(:floors)
end
